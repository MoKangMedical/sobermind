    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FAF7F0] px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-2xl font-bold text-ink mb-2">欢迎回来</h1>
          <p className="text-muted">继续你的清醒之旅</p>
        </div>
        ...
        <p className="text-center mt-6 text-sm text-muted">
          还没有账号？{' '}
          <Link href="/register" className="text-sage hover:text-sage-dark font-medium">
            注册
          </Link>
        </p>
      </div>
